...
-- Se utiliza SELECT * para explorar rápidamente la estructura y el contenido de la tabla.
-- En producción es recomendable seleccionar solo las columnas necesarias.
